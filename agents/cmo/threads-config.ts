...
- 첫 줄은 공감형 오프닝으로 시작 (50-60대 자연스러운 말투)
- 공감형 오프닝 예시:
  "나만 이런 거 아니지?"
  "오늘 이런 일이 있었는데"
  "솔직히 이 나이에..."
  "요즘 부쩍 그런 생각이 들어"
  "우리 또래라면 한 번쯤은 느껴봤을 텐데"
  "갑자기 생각난 건데, 여러분도?"
- 금지: "이거 모르면 진짜 손해야", "딱 하나만 기억해", "꼭 알아야 해" (YouTube 클릭베이트 스타일 — 타겟 미스매치)
- 스토리텔링 구조: 공감 → 반전/인사이트 → 따뜻한 마무리
- 글자수: 150-350자 (공감 스토리를 충분히 전달할 수 있는 길이)
- 마지막 줄에 질문 1개 의무화: "여러분은 어때요?", "혹시 비슷한 경험 있으신 분?", "어떻게 생각하세요?"
- 끝까지 읽고 싶게 만드는 게 최우선
`.trim()
