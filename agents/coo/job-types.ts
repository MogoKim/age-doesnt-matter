...
export const FEMALE_FRIENDLY_KEYWORDS = [
  // 돌봄/복지
  '강사', '돌봄', '요양', '케어', '간호', '보육', '복지', '사회복지', '생활지원',
  // 식음/서비스
  '바리스타', '카페', '조리', '영양', '급식', '배식', '식당', '조리보조',
  // 사무/안내
  '상담', '코디네이터', '안내', '접수', '사서', '도서관', '행정보조', '사무보조',
  // 교육
  '교육', '봉사', '멘토', '방과후', '학습', '독서',
  // 위생/환경
  '세탁', '청소', '미화', '환경정비', '위생',
  // 문화/여가
  '공방', '수공예', '플라워', '꽃', '원예', '문화', '체험',
  // 판매/고객
  '판매', '매장', '고객', '텔레마케팅', '전화상담', '콜센터',
]
...
export function normalizeSalary(raw: string | undefined | null): string {
  ...
  // "시급 12000원" 또는 "시급 1.2만" — 명시적 시급 먼저 처리
  ...
  // "월급 2800000원" 단일 — 원본 금액 기준으로 월급/시급 판별
...
/** 일자리 정보에서 사용자에게 보여줄 태그를 최대 2개 생성 */
