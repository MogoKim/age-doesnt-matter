...
- **커뮤니티 활성화 v4 — 시드봇 개선** (2026-03-28 구축 완료)
  - [Critical 버그 수정] 시드봇 좋아요 시 promotionLevel 승격 누락 → HOT(10+)/HALL_OF_FAME(50+) 자동 승격 추가
  - [홈페이지] getEditorsPicks에 HOT fallback 추가 (HALL_OF_FAME 부족 시 HOT 글로 채움)
  - [집중 좋아요] 21시 focusedLikeRound — HOT 근접 글(5~9 likes, 48h 이내)에 5명 봇 집중 투입
...
- 시드봇 주간 토론 스타터 (매주 월요일 T가 WEEKLY에 토론 주제 게시)
- 시드봇 크로스 레퍼런스 댓글 (20% 확률로 관련 글 언급)
- 시드봇 요일별 활동 밀도 조절 (주말 1.3배, 월요일 오전 0.7배)
