...
|--------|----------|---------|-----|
| `cmo:card-news-generator` | `agents-daily.yml` | `0 4 * * *` | 매일 13:00 |
...
| 2026-05-12 | runner.ts `cmo:card-news-generator` 핸들러 등록 + agents-daily.yml 13:00 KST 크론 연결 | QA 딥다이브 — REGISTRY 등록됐으나 크론 미연결 상태 발견 |
