...
| A28 | 네이버 블로그 수동 발행 큐 | ~~`agents/naver-blog/*`~~ 삭제, `src/app/admin/(panel)/naver-blog/*` 보존 | — | LOCAL_ONLY | GROWTH | — | Gemini 구독 종료로 폐기 (2026-06-04). 어드민/NaverBlogQueue 테이블/R2 이미지 보존 | ARCHIVED | 2026-06-04 |
