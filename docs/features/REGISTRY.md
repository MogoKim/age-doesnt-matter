...
| F03 | 히어로 배너 | `src/components/features/home/HeroSlider.tsx` | 홈 방문 | RELATION | P1 | [F03](F03-hero-banner.md) | ACTIVE | 2026-05-10 |
...
| A02 | 매거진 자동생성 | `agents/cafe/magazine-generator.ts` + `local-magazine-runner.ts` | launchd 15:00, 17:00 KST | LOCAL_ONLY | HEALTH+MONEY+RETIRE | P2·P4 | [F05](F05-magazine.md) | ACTIVE | 2026-05-11 |
...
| A05 | 시드봇 35명 | `agents/seed/` | GHA 하루 16회 (08~23시) | GHA | RELATION+HEALTH | ALL | [A05](A05-seed-bot.md) | ACTIVE | 2026-05-09 |
