...
| F05 | 매거진 | `src/app/(main)/magazine/` | 자동생성(A02) + 사용자 탐색 | [F05](F05-magazine.md) | ACTIVE | 2026-04-29 |
...
| A02 | 매거진 자동생성 | `agents/cafe/magazine-generator.ts` + `local-magazine-runner.ts` | launchd 15:00, 17:00 KST | LOCAL_ONLY | [F05](F05-magazine.md) | ACTIVE | 2026-04-29 |
