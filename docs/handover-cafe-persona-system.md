...
> ⚠️ **ARCHIVED (2026-07-10 감사 판정)** — 이 문서는 2026-05-11 시점 스냅샷이다.
> **시드봇 글쓰기는 2026-06-03 retired**(커밋 9c98ad7)되어 아래 "시드봇 메인/마이크로 활동" 표와 일일 목표 수치는 더 이상 사실이 아니다.
> **현재 발행 체계 = CONTENT_CURATE(GHA `agents-cafe-hourly-curation.yml`) + SHEET/댓글 wave 중심.**
> 아래 본문은 "은퇴 전 스냅샷"으로만 보존한다 — 현재 상태 판단·재활성화 근거로 사용 금지. 현행 확인은 `.env.local` + `.github/workflows/` 실물 기준.
...
## 섹션 0. 지금 당장 알아야 할 것들 (⚠️ 은퇴 전 스냅샷)

### A. 현재 정상 작동 중인 것들 (⚠️ 2026-05-11 기준 — 시드봇 행은 2026-06-03 retired)
...
**일일 시드봇 목표 수치 (⚠️ 과거 기록 — 시드봇 글쓰기 2026-06-03 retired, 현재 목표 아님):**
