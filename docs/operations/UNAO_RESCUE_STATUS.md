...
| 단계 | 대상 | 현재 파악된 것 |
|---|---|---|
| **R4** | C-level 및 역할극 에이전트 | **ORG_THEATER 10개 + SUPERSEDED 4개 제거 완료(2026-09-08).** 삭제 후보 잔여 **13개**(GROWTH_LEGACY), 유지 14개 |
| **R4** | 사용하지 않는 workflow · runner · registry | 크론 키 **64개** 중 linked **43** · orphaned **21**(dispatchOnly **13** · localOnly **8**). GHA 25개 중 21개 `disabled_manually`, 활성 4개 |
