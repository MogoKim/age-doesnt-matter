...
export const CARDS: Card[] = [
  ...
  s('C-BL-TWA-AB', 'TWA 첫 진입 A/B 테스트 (게이트)', 'T2-성능', '배포완료-적용확인', 'Phase1 게이트 배포완료(a9c9a5c, 2026-06-08): 신규 TWA 사용자 A34현행/B33soft(글3개후)/C33hard(첫화면)+탈출구. sign_up 그룹기록·twa_gate_view 노출·getGateRetention 재방문측정·TWA배너OFF(오염차단). 함정=가입률단독, 정답=가입후 D1/D7재방문. ⚠️실기기(안드로이드) 테스트 필요. 운영 3~6개월·위너 유의시 100%도입'),
