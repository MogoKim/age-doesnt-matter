...
const FAQ_GROUPS: Array<{ group: string; items: FaqItem[] }> = [
    ...
    items: [
      {
        ...
        a: '50·60대를 위한 커뮤니티 플랫폼입니다. 자유로운 소통, 내일찾기(일자리 정보), 건강·생활 매거진 등을 제공합니다.',
      },
      {
        q: '가입은 어떻게 하나요?',
        a: (
  ...
  },
  {
    ...
    items: [
      {
        q: '일자리 정보는 어디서 보나요?',
        a: '상단 메뉴의 [내일찾기] 탭에서 지역, 급여, 근무시간 등 조건별로 일자리를 찾을 수 있습니다.',
      },
      {
        q: '글자 크기를 바꿀 수 있나요?',
        a: '네, 마이페이지 > 설정 > 글자 크기에서 작게/기본/크게 중 선택할 수 있습니다.',
      },
    ],
  },
]
...
const LIFE_STAGE_FAQ_JSON_LD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '우나어 내일찾기(일자리) 메뉴에서 50·60대 친화 채용 공고를 매일 확인할 수 있습니다. 경비, 요양보호사, 사무보조, 배달 등 중장년이 지원할 수 있는 직종 위주로 업데이트되며, 재취업 경험담도 커뮤니티에서 나눌 수 있습니다.',
      },
    },
    {
      '@type': 'Question',
...
export default async function AboutPage() {
  ...
  return (
    <div className="max-w-[720px] mx-auto">
          ...
          {VALUE_CARDS.map((card) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-caption text-primary-strong font-bold bg-primary/10 rounded-full px-2.5 py-0.5">
                  {card.label}
                </span>
              </div>
      ...
      {/* 섹션 4 — FAQ */}
      <section id="faq" className="px-4 pb-14 md:px-6">
