  ...
  return (
    <div className="max-w-[720px] mx-auto px-4 py-8 md:px-6 md:py-12">
      ...
      <section className="mb-10">
        <p className="text-base text-foreground leading-[1.85] break-keep mb-4">
      ...
      <section className="mb-10">
        ...
        <p className="text-base text-foreground leading-[1.85] break-keep mb-6">
...
function FeatureCard({ emoji, title, description }: { emoji: string; title: string; description: string }) {
  return (
    <div className="flex gap-4 p-4 bg-card rounded-xl border border-border">
      ...
      <div>
        <h3 className="text-base font-bold text-foreground m-0 mb-1">{title}</h3>
