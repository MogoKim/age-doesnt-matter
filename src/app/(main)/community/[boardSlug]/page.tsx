...
function getBoardFaqJsonLd(boardSlug: string): object | null {
  const faqs: Record<string, Array<{ q: string; a: string }>> = {
    ...
    // 갱년기 톡: 경험·공감 중심 답변 — 의료 단정 금지, 병원 상담 권유 수준까지만 (YMYL 안전)
    menopause: [
      { q: '갱년기 증상은 나만 심한 건가요?', a: '아니에요. 안면홍조, 식은땀, 불면, 감정 기복은 40대 50대 60대 여성이 아주 흔하게 겪는 변화입니다. 우나어 갱년기 톡에서 같은 시기를 지나는 분들의 경험담을 읽어보면 "나만 그런 게 아니구나" 하고 마음이 놓여요.' },
      { q: '갱년기에 감정 기복과 우울감이 심해요, 어떻게 하나요?', a: '호르몬 변화로 감정이 널뛰는 것은 자연스러운 과정이에요. 우나어 갱년기 톡에서 비슷한 경험을 나눈 분들의 이야기와 생활 관리법을 볼 수 있습니다. 다만 일상이 어려울 정도로 힘들다면 병원 상담을 함께 받아보시길 권해요.' },
      { q: '완경 후 몸 관리는 어떻게 시작하나요?', a: '우나어 갱년기 톡에서는 완경 전후를 지나온 또래들이 운동, 식단, 검진 후기 같은 실제 경험을 나눕니다. 사람마다 몸이 다르니 경험담을 참고하되, 구체적인 치료나 호르몬 관련 결정은 의료진과 상의하는 것이 좋아요.' },
    ],
  }
