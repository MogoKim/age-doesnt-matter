...
const ACTION_LABELS: Record<string, string> = {
  POST_PUBLISHED: '게시글 복원',
  POST_HIDDEN: '게시글 숨김',
  POST_DELETED: '게시글 삭제',
  POST_PIN: '게시글 핀 고정',
  POST_UNPIN: '게시글 핀 해제',
  POST_FEATURED_ON: '게시글 집중 ON',
  POST_FEATURED_OFF: '게시글 집중 OFF',
  BULK_HIDDEN: '일괄 숨김',
  BULK_DELETED: '일괄 삭제',
  BULK_EXPIRE_JOBS: '만료 일자리 숨김',
  POST_LIKE_COUNT_SET: '공감수 수동 설정',
  PROMOTION_LEVEL_CHANGE: '등급 변경',
  USER_ACTIVE: '제재 해제',
  USER_SUSPENDED: '회원 정지',
  USER_BANNED: '회원 영구 차단',
  USER_GRADE_CHANGE: '회원 등급 변경',
  REPORT_HIDDEN: '신고 처리 — 숨김',
  REPORT_DELETED: '신고 처리 — 삭제',
  REPORT_DISMISSED: '신고 기각',
  REPORT_WARNING: '신고 처리 — 경고',
  REPORT_SUSPENDED: '신고 처리 — 정지',
  REPORT_BANNED: '신고 처리 — 차단',
  BANNER_CREATE: '배너 생성',
  BANNER_UPDATE: '배너 수정',
  BANNER_DELETE: '배너 삭제',
  AD_CREATE: '광고 생성',
  AD_UPDATE: '광고 수정',
  AD_DELETE: '광고 삭제',
  BOARD_CONFIG_UPDATE: '게시판 설정 변경',
  BANNED_WORD_CREATE: '금지어 추가',
  BANNED_WORD_DELETE: '금지어 삭제',
  BANNED_WORD_ACTIVATE: '금지어 활성화',
  BANNED_WORD_DEACTIVATE: '금지어 비활성화',
