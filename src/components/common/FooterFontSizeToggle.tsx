...
// 읽어주는 이름은 font-size-labels 한 곳에서 가져온다 — 화면마다 다르게 부르던 걸 맞췄다.
const SIZES = [
  { key: 'NORMAL', label: '가', class: 'text-caption' },
  { key: 'LARGE', label: '가', class: 'text-title' },
  { key: 'XLARGE', label: '가', class: 'text-heading' },
] as const
