...
export default function PostCard({ post, boardSlug }: PostCardProps) {
  return (
    ...
    >
      {post.category && (
        <span className="inline-flex items-center px-3 py-1 rounded-full bg-primary/10 text-foreground text-caption font-bold w-fit tracking-wide">{post.category}</span>
      )}
