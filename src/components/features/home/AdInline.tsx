export default function AdInline() {
  return (
    <aside className="bg-[#F9F5F0] border-y border-border px-4 py-3 relative">
      ...
      <div className="h-[100px] flex items-center justify-center text-muted-foreground text-xs">광고 영역</div>
    </aside>
  )
}
