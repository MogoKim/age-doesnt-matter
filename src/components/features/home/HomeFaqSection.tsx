...
const HOME_FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '우나어(우리 나이가 어때서)는 스마트폰에 최적화된 웹 서비스로, 별도 앱 설치 없이 카카오톡 계정으로 1초 만에 가입해 이용할 수 있습니다. 50대·60대가 편하게 쓸 수 있도록 큰 글씨와 간단한 화면으로 만들었습니다.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '우나어는 완전 무료 커뮤니티입니다. 가입비·월정액·광고 없이 카카오 계정으로 1초 만에 가입해 모든 기능을 이용할 수 있습니다.',
      },
    },
  ],
}
...
const HOME_FAQ_ITEMS: FaqItem[] = [
  ...
  {
    q: '앱을 설치해야 하나요?',
    a: '앱 설치 없이 바로 쓸 수 있어요. 카카오톡 계정으로 1초 만에 가입하면 스마트폰 브라우저에서 바로 이용 가능합니다.',
  },
  {
    q: '가입비가 있나요?',
