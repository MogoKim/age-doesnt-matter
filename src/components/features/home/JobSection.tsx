  ...
  return (
    <section className="py-4 border-b-4 border-background lg:py-8 lg:border-b-0">
      <div className="flex items-center justify-between mb-4 px-4 lg:px-0">
        ...
        <HomeCardLink href="/jobs" className="text-caption text-muted-foreground no-underline flex items-center gap-1 p-2 -m-2 min-h-control min-w-control hover:text-primary-text" section="jobs" position={-1} contentId="" action="more">
          전체보기 →
        </HomeCardLink>
      </div>
