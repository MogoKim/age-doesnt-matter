  ...
  return (
    <section className="py-4 border-b-4 border-background lg:py-8 lg:border-b-0">
      <div className="flex items-center justify-between mb-4 px-4 lg:px-0">
        ...
        <HomeCardLink href="/magazine" className="text-caption text-muted-foreground no-underline flex items-center gap-1 p-2 -m-2 min-h-[52px] min-w-[52px] hover:text-primary-text" section="magazine" position={-1} contentId="" action="more">
          전체보기 →
        </HomeCardLink>
      </div>
