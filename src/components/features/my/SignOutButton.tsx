...
export default function SignOutButton() {
  ...
  return (
    <>
      <button
        className="flex items-center gap-3 w-full min-h-control-lg px-6 py-4 text-body font-medium text-muted-foreground bg-transparent border-none cursor-pointer transition-colors hover:bg-primary/5 hover:text-foreground text-left"
