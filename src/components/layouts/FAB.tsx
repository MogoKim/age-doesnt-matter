...
export default function FAB({ isLoggedIn = false }: FABProps) {
  ...
  const fabClassName = cn(
    'group fixed bottom-6 right-6 z-[97] flex items-center gap-2 h-[52px] px-6 bg-primary text-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] text-body font-bold cursor-pointer transition-all duration-200 no-underline [-webkit-tap-highlight-color:transparent] active:scale-95',
